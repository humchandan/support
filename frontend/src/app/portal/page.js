...
import UtilityPortalView from '../../components/UtilityPortalView';
    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-black text-white font-sans">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-zinc-400 font-medium tracking-wide">Loading Utility Portal...</span>
        </div>
      </div>
    );
  }
