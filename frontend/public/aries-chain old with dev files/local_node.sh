...
if [[ $overwrite == "y" || $overwrite == "Y" ]]; then
  ...
  # Fund the validator key with exactly 60,000 ARES (6 * 10^22 aares) in genesis
  echo "💰 Funding validator account with 60,000 ARES..."
  ariesd genesis add-genesis-account "$VAL_ADDR" 60000000000000000000000aares --home "$CHAINDIR"

  # Fund the main public wallet with 2.1 Billion ARES (2.1 * 10^27 aares) in genesis
  echo "💰 Funding main public distribution wallet (0x0d85062FB39139A2601C87B376C883a1e2Db8D20) with 2.1 Billion ARES..."
  ariesd genesis add-genesis-account 0x0d85062FB39139A2601C87B376C883a1e2Db8D20 2100000000000000000000000000aares --home "$CHAINDIR"
